...
(function() {
  const translations = {
    es: {
      ...
      aiSummaryDisclaimer: "Aviso: esta s\u00edntesis autom\u00e1tica puede ser imprecisa; consulta a un astr\u00f3logo kabalista profesional para una lectura formal.",
      aiSummaryButton: "Agendar gu\u00eda espiritual",
    ...
    en: {
      ...
      aiSummaryDisclaimer: "Disclaimer: this automatic synthesis may be inaccurate; seek a professional Kabbalistic astrologer for a proper reading.",
      aiSummaryButton: "Book spiritual guidance",
